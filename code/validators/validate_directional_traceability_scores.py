...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate CHVD directional traceability output JSON.")
    parser.add_argument("--input", required=True, help="Path to directional traceability JSON.")
