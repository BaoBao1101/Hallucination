...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate CHVD individual judge output JSON.")
    parser.add_argument("--input", required=True, help="Path to individual score JSON.")
    parser.add_argument("--out", required=True, help="Path for audit JSON.")
    parser.add_argument("--allow-invalid", action="store_true", help="Write audit and return exit code 0 even if invalid.")
